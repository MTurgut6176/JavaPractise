...
public class C06_StringManipulationsLength {
    ...
    public static void main(String[] args) {
        ...
        //girilen kelimeyi tersten yazin

        Scanner input2 = new Scanner(System.in);
        System.out.println("4 karakterli kelime giriniz");
        ...
        if (kelime.length()==4 ){
            ...
            System.out.println("kelime 4 krakterden fazla");
        } else if (kelime.length() < 4) {
            System.out.println("kelime 4 karakterden az");
