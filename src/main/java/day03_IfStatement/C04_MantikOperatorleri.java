...
public class C04_MantikOperatorleri {
    // && ile & arasindaki fark daha hizli calistirir.
    ...
    public static void main(String[] args) {
        ...
        boolean sonuc2=5>4 & 7>9 & 6+3==9 & 5+2!=8; //cay ve seker ikiside olacak mukemmeliyeci
        ...
        //sayi2 'nin 10 ile 20 'nin arasinda olmadigini true diyerek donduren bir kod yaziniz  // veya"|| cay yada kahve
