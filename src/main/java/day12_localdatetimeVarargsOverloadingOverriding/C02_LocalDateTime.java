...
public class C02_LocalDateTime {
    ...
    public static void main(String[] args) {
        ...
        //soru -iki saat arsindaki farki hesaplama
        //japonya ve Almanya arsindaki faki hesaplatan kodu yaziniz
        ...
        System.out.println(dtf6.format(time2.plusHours(2)));//10:48:00 eklenince
